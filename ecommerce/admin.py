...
class TaxAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'tax_category', 'percentage', 'created_at')
...
class AttributeTemplateAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'display_name', 'input_type', 'is_active', 'created_at')
    search_fields = ('name', 'display_name')
    list_filter = ('input_type', 'is_active')

@admin.register(Unit)
class UnitAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'attribute_template', 'is_active', 'created_at')
    search_fields = ('name', 'attribute_template__name')
    list_filter = ('is_active', 'attribute_template')

@admin.register(AttributeOption)
class AttributeOptionAdmin(admin.ModelAdmin):
    list_display = ('id', 'value', 'attribute_template', 'unit', 'display_order', 'is_active')
    search_fields = ('value', 'attribute_template__name')
    list_filter = ('is_active', 'attribute_template')

@admin.register(ProductTemplate)
class ProductTemplateAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'display_name', 'commission_type', 'commission_value', 'is_active')
    search_fields = ('name', 'display_name')
...
class ProductTemplateAttributeAdmin(admin.ModelAdmin):
    list_display = ('id', 'product_template', 'attribute_template', 'is_required', 'display_order', 'is_active')
...
class ProductTemplateNodeMappingAdmin(admin.ModelAdmin):
    list_display = ('id', 'product_template', 'level', 'node')
    search_fields = ('product_template__name', 'node__name')
    list_filter = ('level',)

@admin.register(Product)
class ProductAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'business', 'product_template', 'status', 'is_visible')
...
class ProductVariantsAdmin(admin.ModelAdmin):
    list_display = ('id', 'sku_code', 'product', 'price', 'is_visible')
...
class ProductVariantAttributeValueAdmin(admin.ModelAdmin):
    list_display = ('id', 'product_variant', 'attribute_template', 'text_value', 'attribute_option')
