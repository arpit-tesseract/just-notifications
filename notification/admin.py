...
class NotificationTemplateAdmin(admin.ModelAdmin):
    list_display = ('id', "name", "title", "category", "templatefile", "is_active", "created_at")
...
class NotificationAdmin(admin.ModelAdmin):
    list_display = ('id', "title", "status", "template", "is_active", "created_at")
...
class NotificationRecipientAdmin(admin.ModelAdmin):
    list_display = ('id', "user", "notification", "channel", "status", "delivery_status", "read_at")
